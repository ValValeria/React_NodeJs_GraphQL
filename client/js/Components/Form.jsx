...
export default function (){
    ...
    return (
      <section style={{minHeight:"50vh"}} className="form__section light " id="contact"> 
      ...
      <Form className="m-auto" id="myform" >
        ...
        <Form.Group>
          <Button  variant="contained" onClick={sumbit} className="d-block w-100 text-center"  color="primary">Send</Button>
        </Form.Group>
      </Form>
      </section>
    )
